      ...
      >
        ...
        <nav className="space-y-3">
          <SidebarItem
            icon={homeIcon}
            label="Dashboard"
            onClick={() => navigate("/Auditor/dashboardauditor")}
            active={location.pathname === "/Auditor/dashboardauditor"}
          />

          <SidebarItem
            icon={laporanIcon}
            label="Laporan"
            onClick={() => navigate("/Auditor/LaporanAuditor")}
            active={location.pathname.startsWith("/Auditor/LaporanAuditor")}
          />
        </nav>
        ...
        <SidebarItem 
          icon={helpIcon} 
          label="Bantuan" 
          onClick={() => navigate("/Auditor/BantuanAuditor")}
          active={location.pathname === "/Auditor/BantuanAuditor"} 
        />
