      ...
      >
        ...
        <nav className="space-y-3">
          <SidebarItem
            icon={homeIcon}
            label="Dashboard"
            onClick={() => navigate("/Diskominfo/dashboarddiskominfo")}
            active={location.pathname === "/Diskominfo/dashboarddiskominfo"}
          />
          ...
          <SidebarItem
            icon={riwayatIcon}
            label="Riwayat"
            onClick={() => navigate("/Diskominfo/DaftarRiwayatDiskominfo")}
            active={location.pathname.startsWith("/Diskominfo/DaftarRiwayatDiskominfo")}
          />
        </nav>
        ...
        <SidebarItem 
          icon={helpIcon} 
          label="Bantuan" 
          onClick={() => navigate("/Diskominfo/BantuanDiskominfo")}
          active={location.pathname === "/Diskominfo/BantuanDiskominfo"} 
        />
