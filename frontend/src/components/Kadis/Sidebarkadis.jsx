      ...
      >
        ...
        <nav className="space-y-3">
          <SidebarItem
            icon={homeIcon}
            label="Dashboard"
            onClick={() => navigate("/Kadis/dashboardkadis")}
            active={location.pathname === "/Kadis/dashboardkadis"}
          />

          <SidebarItem
            icon={permohonanIcon}
            label="Aset"
            onClick={() => navigate("/Kadis/AsetSayaKadis")}
            active={location.pathname.startsWith("/Kadis/AsetSayaKadis")}
          />

          <SidebarItem
            icon={riwayatIcon}
            label="Riwayat"
            onClick={() => navigate("/Kadis/riwayatapprovalkadis")}
            active={location.pathname.startsWith("/Kadis/riwayatapprovalkadis")}
          />
        </nav>
        ...
        <SidebarItem 
          icon={helpIcon} 
          label="Bantuan" 
          onClick={() => navigate("/Kadis/BantuanKadis")}
          active={location.pathname === "/Kadis/BantuanKadis"} 
        />
