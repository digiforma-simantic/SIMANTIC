...
import Headerbantuanauditor from "../../components/Auditor/HeaderBantuanAuditor";
...
const questions = [
  { text: "Bagaimana cara melakukan penindakan pengajuan?", path: "/BantuanAuditor1" },
  { text: "Bagaimana cara melihat riwayat yang telah saya tindak?", path: "/BantuanAuditor2" },
  { text: "Bagaimana cara melihat riwayat status perubahan sebelumnya?", path: "/BantuanAuditor3" },
  { text: "Bagaimana cara memperbarui informasi profil saya?", path: "/BantuanAuditor4" },
];
...
export default function Bantuan() {
  return (
    <div className="min-h-screen bg-[#F7FCFF] font-geologica">
      ...
      {/* Header Bantuan */}
      <Headerbantuanauditor title="Bantuan" />
