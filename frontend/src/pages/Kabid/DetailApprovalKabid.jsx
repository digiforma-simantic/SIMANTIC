  ...
  const handleForward = async () => {
    try {
      ...
      if (!response.success) {
        ...
        alert('RFC berhasil diteruskan ke Kepala Dinas!');
        fetchRfcs();
      }
    } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Tolak */}
              <button className="w-full bg-[#B30000] hover:bg-red-800 text-white font-semibold py-3 rounded-lg transition" disabled>
                Tolak
              </button>
