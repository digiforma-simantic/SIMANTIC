...
import Sidebarkabid from "../../components/Kabid/Sidebarkabid";
import Headerkabid from "../../components/Kabid/Headerkabid";

const RiwayatApprovalKabid = () => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {approvals.map((item) => (
                ...
                >
                  ...
                  <button
                    onClick={() => navigate(`/Kabid/DetailPermohonanKabid/${item.id}`)}
...
export default RiwayatApprovalKabid;