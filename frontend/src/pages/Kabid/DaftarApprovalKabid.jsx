...
import Headerdafapp from "../../components/Kabid/Headerdafapp";

const DaftarApprovalKabid = () => {
          ...
          {approvals.map((item) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <button
                onClick={() => navigate(`/Kabid/DetailApprovalKabid/${item.id}`)}
...
export default DaftarApprovalKabid;
