...
import Headerbantuandiskominfo from "../../components/Diskominfo/Headerbantuandiskominfo";
...
const questions = [
  { text: "Bagaimana cara melakukan penindakan pengajuan?", path: "/BantuanDiskominfo1" },
  { text: "Bagaimana cara melihat riwayat yang telah saya tindak?", path: "/BantuanDiskominfo2" },
  { text: "Bagaimana cara melihat riwayat status perubahan sebelumnya?", path: "/BantuanDiskominfo3" },
  { text: "Bagaimana cara memperbarui informasi profil saya?", path: "/BantuanDiskominfo4" },
];
...
export default function Bantuan() {
  return (
    <div className="min-h-screen bg-[#F7FCFF] font-geologica">
      ...
      {/* Header Bantuan */}
      <Headerbantuandiskominfo title="Bantuan" />
