...
import Headerbantuan from "../../components/Diskominfo/Headerbantuandiskominfo";

export default function BantuanDiskominfo() {
  return (
      ...
      <main className="w-full flex justify-center px-4 py-10">
        <div className="w-full max-w-[1150px] bg-[#F2FAFF] border border-[#E2EDF5] shadow-md rounded-2xl p-10">
          ...
          <p className="text-gray-600 mb-10 ml-2">
            Anda dapat melihat riwayat pengajuan dengan beberapa langkah seperti berikut :
          </p>
