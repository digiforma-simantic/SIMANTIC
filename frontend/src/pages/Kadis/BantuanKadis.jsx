...
import Headerbantuankadis from "../../components/Kadis/HeaderBantuanKadis";
...
const questions = [
  { text: "Bagaimana cara melakukan penindakan pengajuan?", path: "/BantuanKadis1" },
  { text: "Bagaimana cara melihat riwayat yang telah saya tindak?", path: "/BantuanKadis2" },
  { text: "Bagaimana cara melihat riwayat status perubahan sebelumnya?", path: "/BantuanKadis3" },
  { text: "Bagaimana cara memperbarui informasi profil saya?", path: "/BantuanKadis4" },
];
...
export default function Bantuan() {
  return (
    <div className="min-h-screen bg-[#F7FCFF] font-geologica">
      ...
      {/* Header Bantuan */}
      <Headerbantuankadis title="Bantuan" />
