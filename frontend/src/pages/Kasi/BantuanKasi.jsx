...
const questions = [
  ...
  { text: "Bagaimana cara melihat riwayat status perubahan sebelumnya?", path: "/BantuanKasi3" },
  { text: "Bagaimana cara memperbarui informasi profil saya?", path: "/BantuanKasi4" },
];
