...
import Sidebarkasi from "../../components/Kasi/Sidebarkasi";
import Headerkasi from "../../components/Kasi/Headerkasi";

const RiwayatApprovalKasi = () => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {approvals.map((item) => (
                ...
                >
                  ...
                  <button
                    onClick={() => navigate(`/Kasi/DetailPermohonanKasi/${item.id}`)}
...
export default RiwayatApprovalKasi;