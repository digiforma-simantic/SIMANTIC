          ...
          <View style={styles.headerTopRow}>
            ...
            <View style={styles.actionContainer}>
              <TouchableOpacity
                ...
                onPress={() => router.push("/kabid/bantuan")}
              >
                <Image
              ...
              <TouchableOpacity
                ...
                onPress={() => router.push("/kabid/notifikasi")}
              >
                <Image
        ...
        <View style={styles.content}>
          ...
          <View style={styles.sectionCard}>
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity onPress={() => router.push("/kabid/daftarapproval")}>
            ...
            {approvalData.map((item) => (
              <View key={item.id} style={styles.listItem}>
                ...
                <TouchableOpacity
                onPress={() => router.push("/kabid/detailapproval")}
                >
          ...
          <View style={styles.sectionCard}>
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity onPress={() => router.push("/kabid/daftarpengajuan")}>
                <Text style={styles.seeAllText}>Lihat Semua</Text>
              </TouchableOpacity>
            </View>
            ...
            {submissionData.map((item) => (
              <View key={item.id} style={styles.listItem}>
                ...
                <TouchableOpacity
                onPress={() => router.push("/kabid/status")}
                >
