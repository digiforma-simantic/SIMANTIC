    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Anda dapat membuat laporan audit dengan beberapa langkah seperti berikut :
        </Text>
        ...
        <View style={styles.stepItem}>
          ...
          <Text style={styles.stepText}>
            Pergi ke halaman <Text style={styles.bold}>Laporan</Text>
          </Text>
        </View>
        ...
        <View style={styles.stepItem}>
          ...
          <Text style={styles.stepText}>
            Pastikan yang kami isi sudah benar
          </Text>
        </View>
        <View style={styles.divider} />
