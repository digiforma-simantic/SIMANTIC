...
const BantuanScreen = () => {
  ...
  const questions: QuestionItem[] = [
    {
      id: 1,
      text: "Bagaimana cara memberi catatan audit pada laporan?",
      route: "/auditor/bantuan1",
    },
    {
      id: 2,
      text: "Bagaimana cara membuat laporan audit?",
      route: "/auditor/bantuan2",
    },
    {
      id: 3,
      text: "Bagaimana cara melihat riwayat laporan audit yang telah dibuat?",
      route: "/auditor/bantuan3",
    },
    {
      id: 4,
      text: "Bagaimana cara melihat informasi profil saya?",
      route: "/auditor/bantuan4",
    },
  ];
