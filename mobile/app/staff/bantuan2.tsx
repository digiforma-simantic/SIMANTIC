    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>
          Bagaimana cara melihat detail{"\n"}aset saya?
        </Text>

        <Text style={styles.description}>
          Anda dapat melihat detail aset anda dengan beberapa langkah seperti berikut :
        </Text>
        ...
        <View style={styles.stepItem}>
          ...
          <Text style={styles.stepText}>
            Pergi ke halaman <Text style={styles.bold}>Aset</Text>
          </Text>
        </View>
        ...
        <View style={styles.stepItem}>
          ...
          <Text style={styles.stepText}>
            Klik <Text style={styles.bold}>Lihat Detail</Text>
          </Text>
        </View>
        <View style={styles.divider} />
