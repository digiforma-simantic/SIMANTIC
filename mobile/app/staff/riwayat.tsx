...
export default function RiwayatScreen() {
  ...
  const riwayatData = [
    ...
    { id: 6, title: "Install Aplikasi Kerja", code: "#0001", date: "17 Agustus 2025", status: "success" },
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TextInput
          ...
          placeholder="Cari pengajuan perubahan..."
          placeholderTextColor="#9E9E9E"
          value={searchText}
          onChangeText={setSearchText}
        />

        <TouchableOpacity onPress={() => router.push("/staff/filter")}>
          <Image
        ...
        >
          {riwayatData.map((item, index) => (
            ...
            >
              ...
              <TouchableOpacity style={styles.statusButton} onPress={() => router.push("/staff/status")}>
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    height: 410, // ✅ KOTAK RIWAYAT DIBATASI (TIDAK SCROLL)
  },
