...
<body class="bg-secondary">
  <div class="bg-white container-sm col-6 border my-3 rounded px-5 py-3 pb-5">
    <h1>Halo!!</h1>
    <div>Selamat datang di halaman opd</div>
    ...
    <div class="card mt-3">
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Menu kasi</li>
        @endif
        @if (Auth::user()->role == 'kepala_bidang')
        <li class="list-group-item">Menu kabid</li>
        @endif
        @if (Auth::user()->role == 'kepala_dinas')
        <li class="list-group-item">Menu kadis</li>
        @endif
        @if (Auth::user()->role == 'diskominfo')
        <li class="list-group-item">Menu diskominfo</li>
        @endif
        @if (Auth::user()->role == 'auditor')
        <li class="list-group-item">Menu auditor</li>
        @endif
      </ul>
    </div>
